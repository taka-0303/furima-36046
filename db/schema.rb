...
ActiveRecord::Schema.define(version: 2021_10_15_060924) do
  ...
  create_table "shipping_infos", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["purchases_id"], name: "index_shipping_infos_on_purchases_id"
  end
  ...
  add_foreign_key "shipping_infos", "purchases", column: "purchases_id"
end
